          ...
          <TableBody>
            {
              ...
              songData.map(x => <TableRow key={x.song_id}>
                <TableCell key='#'>{x.number}</TableCell>
                <TableCell key='Title'>
                  <Link onClick={() => setSelectedSongId(x.song_id)}>
                    {x.title}
                  </Link>
                </TableCell>
                <TableCell key='Plays'>{x.plays}</TableCell>
                <TableCell key='Duration'>{formatDuration(x.duration)} </TableCell>
              </TableRow>)
              //Replace me (use the formatDuration helper function, see SongCard.js for an example)
